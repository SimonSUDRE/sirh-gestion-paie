			...
			<article>
				...
				<div>
					<div class="offset-8 col">
						<b>P&#xE9;riode</b><br /> <span>Du ${ bulletin.periode.dateDebut }
							au ${ bulletin.periode.dateFin }</span>
					</div>
					<div class="col">
						<b>Entreprise</b><br /> ${ bulletin.remunerationEmploye.entreprise.denomination }<br />
					...
					<br /> <b>Net Imposable : ${ calculBulletin.netImposable }</b>
					<table class="table table-sm table-striped">
						<thead class="thead-dark">
							<tr>
								<th scope="col">Rubriques</th>
