...
public class ProfilRemuneration {
	...
	@JoinTable(name="CompoNonImposable",
		joinColumns= @JoinColumn(name="IdProfilRemuneration", referencedColumnName="ID"),
		inverseJoinColumns= @JoinColumn(name="IdCotisationNonImposable", referencedColumnName="ID")
	)
	...
	@JoinTable(name="CompoImposable",
		joinColumns= @JoinColumn(name="IdProfilRemuneration", referencedColumnName="ID"),
		inverseJoinColumns= @JoinColumn(name="IdCotisationImposable", referencedColumnName="ID")
	)
